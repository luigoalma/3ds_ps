...
// Result values
#define PS_NOT_FOUND         MAKERESULT(RL_STATUS, RS_INVALIDARG, RM_PS, RD_NOT_FOUND)
#define PS_NOT_IMPLEMENTED   MAKERESULT(RL_PERMANENT, RS_NOTSUPPORTED, RM_PS, RD_NOT_IMPLEMENTED)
#define PS_INVALID_SELECTION MAKERESULT(RL_STATUS, RS_INVALIDARG, RM_PS, RD_INVALID_SELECTION)
#define PS_INVALID_SIZE      MAKERESULT(RL_STATUS, RS_INVALIDARG, RM_PS, RD_INVALID_SIZE)
